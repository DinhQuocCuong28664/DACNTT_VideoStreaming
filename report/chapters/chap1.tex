...
expected bound against which the vCPU scaling results of Chapter~\ref{chap:implementation} are
interpreted.
...
Chapter~\ref{chap:implementation} was produced by a measurement script committed alongside the
...
design. Chapter~\ref{chap:implementation} details the implementation of each subsystem together
with the infrastructure automation, the difficulties encountered during development and how they
were resolved, the deployed user interface, and the experimental results.
Chapter~\ref{chap:conclusion} summarises what was achieved, states the strengths and limitations
of the delivered system, and outlines directions for future work.
