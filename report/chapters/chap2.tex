...
% Kéo hết bề rộng vùng chữ. Ở 0,82 lần thì chữ nhỏ nhất chỉ in ra 6,21pt, sát
% sàn tới mức thêm một chữ vào nhãn dài nhất là rơi xuống dưới. Ở mức đầy thì
% hình cao 20,7 cm, vẫn vừa một trang cùng chú thích, mà chữ lên 7,58pt.
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{images/07-compute-models.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{images/06-hls-abr.png}
