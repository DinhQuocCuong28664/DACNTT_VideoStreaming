...
covered, and its silence is read as good news. Anything asserted about what a monitor detects is a
claim about the deployed system, and it has to be verified against that system by making the
failure happen, exactly as Section~\ref{sec:content-protection}'s guarantees had to be.
