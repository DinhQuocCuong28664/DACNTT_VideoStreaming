...
One capability stops at the API. The update endpoint accepts a new title, description,
category, tag list or visibility for a video already uploaded, and enforces ownership before
applying any of them, but the channel management view calls it only to change visibility. A
user who mistypes a title therefore has to delete the video and upload it again, which also
discards its view count and comments. The work remaining is a form in the interface rather
