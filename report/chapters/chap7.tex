...
allowing uploaders to update the title, description and category of an existing video without losing
accumulated views, comments, or transcoding artifacts. However, tags management remains confined to
the initial upload form, and thumbnail replacement is not yet supported in the interface; changing a
video's poster requires administrative intervention or re-uploading.
