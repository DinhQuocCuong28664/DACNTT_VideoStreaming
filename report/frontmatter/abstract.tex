...
sharing platform whose transcoding subsystem is built on a \textbf{Serverless Container}
and \textbf{Event-Driven} architecture. Uploading a file to Amazon S3 emits an event that
...
Access Control, while private videos are additionally protected by CloudFront Signed
Cookies so that unauthorised viewers are rejected at the edge even when they know the exact
manifest URL.
