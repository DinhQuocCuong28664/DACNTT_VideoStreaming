...
The system is evaluated along four dimensions: quality of experience, measured both as
Time-to-First-Frame and, by driving the deployed player in a headless browser under emulated
network conditions, as rebuffering ratio, bitrate switching and the bitrate a viewer actually
receives; transcoding pipeline latency across 100~MB, 500~MB, and 1~GB inputs,
